...
class LightGBMClassifier(override val uid: String)
  ...
  val scalePosWeight = new DoubleParam(this, "scale_pos_weight",
    "Set a double value if training data is unbalanced in binary classification scenario")
  setDefault(scalePosWeight -> 1.0)
